...
import os
import numpy as np
#Importing vect from vectorizer.py
from vectorizer import vect

# Flask Frame Webframe
app = Flask(__name__)
...
# Connecting to SQLite and updating the table
...
# route to reviewform HTML file 
@app.route('/')
def index():
	form = ReviewForm(request.form)
	return render_template('reviewform.html', form=form)

# route to results HTML file
